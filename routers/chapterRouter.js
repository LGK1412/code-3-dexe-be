...
router.delete('/:chapterId', authMiddleware.authhenticateUser, authMiddleware.authRole(["author"]), uploadChapterImages.array('images'), chapterController.deleteChapter)
router.patch('/:chapterId', authMiddleware.authhenticateUser, authMiddleware.authRole(["author"]), uploadChapterImages.array('images'), chapterController.updateChapter)
